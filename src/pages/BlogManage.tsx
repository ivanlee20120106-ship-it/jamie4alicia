      ...
      <main className="relative z-10 pt-24 pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <h1 className="text-3xl font-display font-bold text-foreground">管理文章</h1>
            <Button asChild size="sm">
              <Link to="/blog/new"><Plus className="w-4 h-4 mr-1" />新文章</Link>
            </Button>
          </div>
          ...
          {isLoading ? (
            ...
            <p className="text-center text-muted-foreground py-20">还没有文章，开始写一篇吧！</p>
          ) : (
                  ...
                  <CardContent className="p-4 flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      ...
                      <Button
                        ...
                        onClick={() => { if (confirm("确定要删除这篇文章吗？")) deletePost.mutate(p.id); }}
                      >

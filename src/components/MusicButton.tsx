...
const MusicButton = () => {
  ...
  return (
    <>
      ...
      {/* Music Player Panel */}
      {isOpen && (
        <div className="absolute top-full mt-4 left-1/2 -translate-x-1/2 w-80 bg-card/95 backdrop-blur-lg rounded-xl border border-border/50 p-4 shadow-2xl z-50 animate-fade-in">
          {/* Close button */}
          <button
